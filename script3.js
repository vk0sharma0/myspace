  ...
  fetch("http://localhost:8000")
    ...
    .then((data) => {
      ...
      if (a != tot_call_oi_change) {
        ...
        if (z) {
          z = false;
          his_data_con_call.push(0);
          his_data_con_put.push(0);
          }else{
        ...
        if (call_his_data > put_his_data) {
          ...
          z.innerHTML = (call_his_data / put_his_data).toString().split('.')[0] + '.' + (call_his_data / put_his_data).toString().split('.')[1].slice(0, 2) + ' ' + "C";
          ...
          let z = document.createElement('div');
          z.style.padding = '5px';
          z.innerHTML = (call_his_data / put_his_data).toString().split('.')[0] + '.' + (call_his_data / put_his_data).toString().split('.')[1].slice(0, 2) + ' ' + "P";
          z.style.margin = '5px';
        ...
        if (y > x) { diff_value.innerHTML = (x - y).toString().split('-')[1]; } else {
          diff_value.innerHTML = x - y;
        }
        if (x > y) {
